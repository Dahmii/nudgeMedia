  ...
  <div className="absolute inset-0 z-0 bg-black/60" />
      ...
      opacity
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-[0.9]">
          {words.map((word, i) => <span key={i} className="inline-block overflow-hidden mr-4 last:mr-0 align-bottom">
        ...
        <motion.p className="mt-8 text-lg md:text-xl text-nudge-muted font-light tracking-wide max-w-md mx-auto" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
      ...
      <motion.div className="absolute inset-0 z-0 opacity-20 pointer-events-none" initial={{
      opacity: 0
    }} animate={{
      opacity: 0.2
    }} transition={{
